...
function preload()
{
  ...
  startI = loadImage("img/start.png");
...
function setup() {
  ...
  createCanvas(1300, 650);
    ...
    bR.shapeColor = "#F0CBA2";

    bL = createSprite(2200, 1700, 1000, 2016);
    bL.shapeColor = "#F0CBA2";

    bD = createSprite(0, 3200, 4600, 1000);
    bD.shapeColor = "#F0CBA2";

    bU = createSprite(0, 660, 3500, 10);
    bU.visible = false;
    ...
    restart = createSprite(DR.x,DR.y+125);
...
function draw() {
  ...
  if(gameState === 3){
    ...
    textSize(100);
    text("GAME OVER", DR.x - 300, DR.y-100);
  }
